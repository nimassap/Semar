...
if (isset($_REQUEST['id_snk']) && isset($_REQUEST['syarat_ketentuan'])) {
    // Sanitize and store the POST data in variables
    $id = mysqli_real_escape_string($conn, $_REQUEST['id_snk']);
    $text = mysqli_real_escape_string($conn, $_REQUEST['syarat_ketentuan']);

    // SQL query to update data in the database
    $query = "UPDATE syarat_dan_ketentuan SET syarat_ketentuan = '$text' WHERE id_snk = '$id'";
