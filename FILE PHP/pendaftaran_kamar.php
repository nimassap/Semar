...
if ($result->num_rows > 0) {
    ...
    $insertQuery = "INSERT INTO pemesanan (id_mahasiswa, id_jalur, id_opsipembayaran, id_jumlahpenghuni, id_jeniskelamin, id_gedung, id_kamar, id_harga, tanggal_masuk, tanggal_keluar) 
                    VALUES ('$id_mahasiswa', '$id_jalur', '$id_opsipembayaran', '$id_jumlahpenghuni', '$id_jeniskelamin', '$id_gedung', '$id_kamar', '$id_harga', '$update_tanggal_masuk', '$update_tanggal_keluar')";
