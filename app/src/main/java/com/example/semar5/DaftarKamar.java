...
import com.example.semar5.Adapter.DaftarKamarKosongAdapter;
import com.example.semar5.Adapter.DaftarKamarTerisiAdapter;
...
public class DaftarKamar extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intenttoolbar = new Intent(DaftarKamar.this, MainActivity.class);
        ...
        //layout
        drawerLayout = findViewById(R.id.drawer_layout_daftarkamar);
        navigationView = findViewById(R.id.navdrawer_view);
        ...
        //list kamar tersedia
        recyclerView1 = findViewById(R.id.recyclerViewColumn1);
        recyclerView1.setLayoutManager(new LinearLayoutManager(this));

        recyclerView2 = findViewById(R.id.recyclerViewColumn2);
    ...
    //memanggil data kamar yang tersedia dari database
    private void fetchKamarTersedia() {
        RetrofitClient retrofitClient = RetrofitClient.getInstance(this);
        Api apiService = retrofitClient.getApi();

        Call<List<Kamar>> call = apiService.getKamarTersedia();
        call.enqueue(new Callback<List<Kamar>>() {
            @Override
            public void onResponse(Call<List<Kamar>> call, Response<List<Kamar>> response) {
                if (response.isSuccessful()) {
                    List<Kamar> kamarList = response.body();
                    DaftarKamarKosongAdapter adapter = new DaftarKamarKosongAdapter(kamarList);
                    recyclerView1.setAdapter(adapter);

                    TextView totalKosong = findViewById(R.id.total_kosong);
                    int totalKamarKosong = adapter.getItemCount();
                    totalKosong.setText("Total Kamar Kosong : " + totalKamarKosong);
                } else {
                    Toast.makeText(DaftarKamar.this, "Gagal mengambil data", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<Kamar>> call, Throwable t) {
                ...
                Toast.makeText(DaftarKamar.this, "Kesalahan Jaringan", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    //memanggil data kamar yang tersedia dari database
    private void fetchKamarTerisi() {
        RetrofitClient retrofitClient = RetrofitClient.getInstance(this);
        Api apiService = retrofitClient.getApi();

        Call<List<Kamar>> kamarCall = apiService.getKamarTerisi();
        kamarCall.enqueue(new Callback<List<Kamar>>() {
            @Override
            public void onResponse(Call<List<Kamar>> call, Response<List<Kamar>> response) {
                if (response.isSuccessful()) {
                    final List<Kamar> kamarList = response.body();

                    Call<PemesananResponse> pemesananCall = apiService.getPemesananDataSemua();
                    pemesananCall.enqueue(new Callback<PemesananResponse>() {
                        @Override
                        public void onResponse(Call<PemesananResponse> call, Response<PemesananResponse> response) {
                            if (response.isSuccessful()) {
                                ...
                                DaftarKamarTerisiAdapter adapter = new DaftarKamarTerisiAdapter(kamarList, pemesananList);
                                recyclerView2.setAdapter(adapter);

                                TextView totalTerisi = findViewById(R.id.total_terisi);
                                int totalKamarTerisi = adapter.getItemCount();
                                totalTerisi.setText("Total Kamar Terisi : " + totalKamarTerisi);
                            } else {
                                Toast.makeText(DaftarKamar.this, "Gagal mengambil data Pemesanan", Toast.LENGTH_SHORT).show();
                            }
                        }
                    ...
                    Toast.makeText(DaftarKamar.this, "Gagal mengambil data Kamar", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_home) {
            ...
            Intent intent1 = new Intent(DaftarKamar.this, GaleriActivity.class);
            startActivity(intent1);
        } else if (itemId == R.id.nav_carabooking) {
            Intent intent2 = new Intent(DaftarKamar.this, CaraDaftarActivity.class);
            startActivity(intent2);
        } else if (itemId == R.id.nav_snk) {
            Intent intent3 = new Intent(DaftarKamar.this, SnKActivity.class);
            startActivity(intent3);
        } else if (itemId == R.id.nav_login) {
            Intent intent4 = new Intent(DaftarKamar.this, Login.class);
            startActivity(intent4);
        } else if (itemId == R.id.nav_daftar) {
            Intent intent5 = new Intent(DaftarKamar.this, Daftar.class);
            startActivity(intent5);
        } else if (itemId == R.id.nav_helpdesk) {
            Intent intent6 = new Intent(DaftarKamar.this, Helpdesk.class);
            startActivity(intent6);
        } else if (itemId == R.id.nav_about) {
            Intent intent7 = new Intent(DaftarKamar.this, About.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_data_mahasiswa) {
            Intent intent7 = new Intent(DaftarKamar.this, DataMahasiswa.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_ubahpass) {
            Intent intent7 = new Intent(DaftarKamar.this, UbahPassword.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_daftar_kamar) {
            Intent intent8 = new Intent(DaftarKamar.this, DaftarKamar.class);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(DaftarKamar.this, Login.class);
