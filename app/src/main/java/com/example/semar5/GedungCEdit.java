...
public class GedungCEdit extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gedung_c_edit);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GedungCEdit.this, MainActivity.class);
        ...
        //sesuaikan activity
        drawerLayout = findViewById(R.id.drawer_layout_gedungcedit);
        navigationView = findViewById(R.id.navdrawer_view);
        ...
        Button saveEdit = findViewById(R.id.save_gedungc);
    ...
    private void tampilDataGedungC() {

        EditText tvGedungC_1 = findViewById(R.id.tv_gedungc_1);
        EditText tvGedungC_2 = findViewById(R.id.tv_gedungc_2);
        EditText tvGedungC_3 = findViewById(R.id.tv_gedungc_3);
        EditText tvGedungC_4 = findViewById(R.id.tv_gedungc_4);
        EditText tvGedungC_5 = findViewById(R.id.tv_gedungc_5);
        EditText tvGedungC_6 = findViewById(R.id.tv_gedungc_6);
        EditText tvGedungC_7 = findViewById(R.id.tv_gedungc_7);
        EditText tvGedungC_8 = findViewById(R.id.tv_gedungc_8);
        EditText tvGedungC_9 = findViewById(R.id.tv_gedungc_9);
        EditText tvGedungC_10 = findViewById(R.id.tv_gedungc_10);

        RetrofitClient retrofitClient = RetrofitClient.getInstance(this);
        Api api = retrofitClient.getApi();

        Call<List<TampilGedungC>> call = api.getDataGedungC();
            ...
            public void onResponse(Call<List<TampilGedungC>> call, Response<List<TampilGedungC>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (dataItems != null && !dataItems.isEmpty()) {
                        ...
                        Toast.makeText(GedungCEdit.this, "No data available", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(GedungCEdit.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<TampilGedungC>> call, Throwable t) {
                Toast.makeText(GedungCEdit.this, "Network error", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void editDataGedungC() {
        ...
        String editText1 = tvGedungC_1.getText().toString();
        String editText2 = tvGedungC_2.getText().toString();
        String editText3 = tvGedungC_3.getText().toString();
        String editText4 = tvGedungC_4.getText().toString();
        String editText5 = tvGedungC_5.getText().toString();
        String editText6 = tvGedungC_6.getText().toString();
        String editText7 = tvGedungC_7.getText().toString();
        String editText8 = tvGedungC_8.getText().toString();
        String editText9 = tvGedungC_9.getText().toString();
        String editText10 = tvGedungC_10.getText().toString();

        RetrofitClient retrofitClient = RetrofitClient.getInstance(this);
        Api api = retrofitClient.getApi();

        Call<UpdateGedungC> call1 = api.updateDataGedungC(1, editText1);
        Call<UpdateGedungC> call2 = api.updateDataGedungC(2, editText2);
        Call<UpdateGedungC> call3 = api.updateDataGedungC(3, editText3);
        Call<UpdateGedungC> call4 = api.updateDataGedungC(4, editText4);
        Call<UpdateGedungC> call5 = api.updateDataGedungC(5, editText5);
        Call<UpdateGedungC> call6 = api.updateDataGedungC(6, editText6);
        Call<UpdateGedungC> call7 = api.updateDataGedungC(7, editText7);
        Call<UpdateGedungC> call8 = api.updateDataGedungC(8, editText8);
        Call<UpdateGedungC> call9 = api.updateDataGedungC(9, editText9);
        Call<UpdateGedungC> call10 = api.updateDataGedungC(10, editText10);
    ...
    private final Callback<UpdateGedungC> updateResponseCallback = new Callback<UpdateGedungC>() {
        @Override
        public void onResponse(Call<UpdateGedungC> call, Response<UpdateGedungC> response) {
            if (response.isSuccessful()) {
                UpdateGedungC updateGedungC = response.body();
                String status = updateGedungC.getStatus();
                String message = updateGedungC.getMessage();
                if (status.equals("success")) {
                    successCount++;
                } else if (status.equals("error")) {
                    Toast.makeText(GedungCEdit.this, "Gagal Memperbarui Data" + message, Toast.LENGTH_SHORT).show();
                    failureCount++;
                }

                if (successCount + failureCount == 9) {
                    Toast.makeText(GedungCEdit.this, "Data Berhasil Diperbarui", Toast.LENGTH_SHORT).show();
                    successCount = 0;
                    failureCount = 0;

                    Intent intent = new Intent(GedungCEdit.this, GedungC.class);
                    startActivity(intent);
                }

            } else {
                Toast.makeText(GedungCEdit.this, "Error" + response.message(), Toast.LENGTH_SHORT).show();
                failureCount++;
        ...
        @Override
        public void onFailure(Call<UpdateGedungC> call, Throwable t) {
            Toast.makeText(GedungCEdit.this, "Kesalahan jaringan" + t.getMessage(), Toast.LENGTH_SHORT).show();
            failureCount++;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_home) {
            Intent intent1 = new Intent(GedungCEdit.this, MainActivity.class);
            startActivity(intent1);
        } else if (itemId == R.id.nav_carabooking) {
            Intent intent2 = new Intent(GedungCEdit.this, CaraDaftarActivity.class);
            startActivity(intent2);
        } else if (itemId == R.id.nav_galeri) {
            Intent intent3 = new Intent(GedungCEdit.this, GaleriActivity.class);
            startActivity(intent3);
        } else if (itemId == R.id.nav_snk) {
            Intent intent4 = new Intent(GedungCEdit.this, SnKActivity.class);
            startActivity(intent4);
        } else if (itemId == R.id.nav_login) {
            Intent intent5 = new Intent(GedungCEdit.this, Login.class);
            startActivity(intent5);
        } else if (itemId == R.id.nav_daftar) {
            Intent intent6 = new Intent(GedungCEdit.this, Daftar.class);
            startActivity(intent6);
        } else if (itemId == R.id.nav_helpdesk) {
            Intent intent7 = new Intent(GedungCEdit.this, Helpdesk.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_about) {
            Intent intent8 = new Intent(GedungCEdit.this, About.class);
            startActivity(intent8);
        } else if (itemId == R.id.nav_data_mahasiswa) {
            Intent intent7 = new Intent(GedungCEdit.this, DataMahasiswa.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_ubahpass) {
            Intent intent7 = new Intent(GedungCEdit.this, UbahPassword.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_daftar_kamar) {
            Intent intent8 = new Intent(GedungCEdit.this, DaftarKamar.class);
            startActivity(intent8);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(GedungCEdit.this, Login.class);
        startActivity(intent);
        finishAffinity();
    }
}