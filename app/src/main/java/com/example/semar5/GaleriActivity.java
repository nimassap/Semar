...
import com.example.semar5.Adapter.GalleryAdapter;
...
public class GaleriActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GaleriActivity.this, MainActivity.class);
        ...
        recyclerView = findViewById(R.id.recyclerview_galeri);
        ...
        Call<List<String>> call = api.getGambarGaleri();
        call.enqueue(new Callback<List<String>>() {
            ...
            public void onResponse(Call<List<String>> call, Response<List<String>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    // Convert the list of image URLs to an array of strings
                    String[] imageUrlArray = imageUrls.toArray(new String[0]);

                    GalleryAdapter roomsAdapter = new GalleryAdapter(imageUrlArray, GaleriActivity.this);
                    recyclerView.setAdapter(roomsAdapter);
                } else {
                    Toast.makeText(GaleriActivity.this, "Gagal mengambil data", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<String>> call, Throwable t) {
                Toast.makeText(GaleriActivity.this, "Kesalahan jaringan", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        //sesuaikan activity
        drawerLayout = findViewById(R.id.drawer_layout_galeri);
        navigationView = findViewById(R.id.navdrawer_view);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        int itemId = item.getItemId();
        if (itemId == R.id.nav_galeri) {
        } else if (itemId == R.id.nav_home) {
            Intent intent1 = new Intent(GaleriActivity.this, MainActivity.class);
            startActivity(intent1);
        } else if (itemId == R.id.nav_carabooking) {
            Intent intent2 = new Intent(GaleriActivity.this, CaraDaftarActivity.class);
            startActivity(intent2);
        } else if (itemId == R.id.nav_snk) {
            Intent intent3 = new Intent(GaleriActivity.this, SnKActivity.class);
            startActivity(intent3);
        } else if (itemId == R.id.nav_login) {
            Intent intent4 = new Intent(GaleriActivity.this, Login.class);
            startActivity(intent4);
        } else if (itemId == R.id.nav_daftar) {
            Intent intent5 = new Intent(GaleriActivity.this, Daftar.class);
            startActivity(intent5);
        } else if (itemId == R.id.nav_helpdesk) {
            Intent intent6 = new Intent(GaleriActivity.this, Helpdesk.class);
            startActivity(intent6);
        } else if (itemId == R.id.nav_about) {
            Intent intent7 = new Intent(GaleriActivity.this, About.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_data_mahasiswa) {
            Intent intent7 = new Intent(GaleriActivity.this, DataMahasiswa.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_ubahpass) {
            Intent intent7 = new Intent(GaleriActivity.this, UbahPassword.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_daftar_kamar) {
            Intent intent8 = new Intent(GaleriActivity.this, DaftarKamar.class);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(GaleriActivity.this, Login.class);
        startActivity(intent);
        finishAffinity();
    }
