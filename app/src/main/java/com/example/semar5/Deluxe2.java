...
import com.example.semar5.Adapter.SliderDeluxe2Adapter;
...
public class Deluxe2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deluxe2);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Deluxe2.this, MainActivity.class);
        ...
        Call<List<String>> call1 = api.getGambarDeluxe2();
        ...
        call1.enqueue(new Callback<List<String>>() {
            ...
            public void onResponse(Call<List<String>> call, Response<List<String>> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(Deluxe2.this, "Error", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<String>> call, Throwable t) {
                ...
                Toast.makeText(Deluxe2.this, "Kesalahan jaringan", Toast.LENGTH_SHORT).show();
            }
        });


        //sesuaikan activity
        drawerLayout = findViewById(R.id.drawer_layout_deluxe2);
        navigationView = findViewById(R.id.navdrawer_view);
        ...
        Call<List<TampilDeluxe2>> call = api1.getDataDeluxe2();
            ...
            public void onResponse(Call<List<TampilDeluxe2>> call, Response<List<TampilDeluxe2>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (dataItems != null && !dataItems.isEmpty()) {
                        ...
                        TextView tvDeluxe2_3 = findViewById(R.id.tv_deluxe2_3);
                        TextView tvDeluxe2_4 = findViewById(R.id.tv_deluxe2_4);
                        TextView tvDeluxe2_5 = findViewById(R.id.tv_deluxe2_5);
                        TextView tvDeluxe2_6 = findViewById(R.id.tv_deluxe2_6);
                        TextView tvDeluxe2_7 = findViewById(R.id.tv_deluxe2_7);
                        TextView tvDeluxe2_8 = findViewById(R.id.tv_deluxe2_8);
                        TextView tvDeluxe2_9 = findViewById(R.id.tv_deluxe2_9);
                        ...
                        Toast.makeText(Deluxe2.this, "Data tidak tersedia", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Log.e("API_CALL", "onResponse - Error: " + response.code());
                    Toast.makeText(Deluxe2.this, "Gagal mengambil data", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void displayImages(List<String> imageUrls) {
        ...
        //image slider
        sliderView = findViewById(R.id.image_slider_deluxe2);

        SliderDeluxe2Adapter sliderAdapter = new SliderDeluxe2Adapter(imageUrls, Deluxe2.this);
        ...
        sliderAdapter.setOnSliderItemClickListener(new SliderDeluxe2Adapter.OnSliderItemClickListener() {
            @Override
            public void onSliderItemClick(int position) {
                Intent intent = new Intent(Deluxe2.this, ViewSliderPicDeluxe2.class);
    ...
    protected void onStart() {
        ...
        Button edit = findViewById(R.id.edit_deluxe2);
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Deluxe2.this, Deluxe2Edit.class);
                startActivity(intent);
            }
        });

        //button pindah activity ke pendaftaran kamar
        Button buttbookingnow = findViewById(R.id.booknow_deluxe2);
        buttbookingnow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Deluxe2.this, BookingSekarang.class);
                startActivity(intent);
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_home) {
            Intent intent1 = new Intent(Deluxe2.this, MainActivity.class);
            startActivity(intent1);
        } else if (itemId == R.id.nav_carabooking) {
            Intent intent2 = new Intent(Deluxe2.this, CaraDaftarActivity.class);
            startActivity(intent2);
        } else if (itemId == R.id.nav_galeri) {
            Intent intent3 = new Intent(Deluxe2.this, GaleriActivity.class);
            startActivity(intent3);
        } else if (itemId == R.id.nav_snk) {
            Intent intent4 = new Intent(Deluxe2.this, SnKActivity.class);
            startActivity(intent4);
        } else if (itemId == R.id.nav_login) {
            Intent intent5 = new Intent(Deluxe2.this, Login.class);
            startActivity(intent5);
        } else if (itemId == R.id.nav_daftar) {
            Intent intent6 = new Intent(Deluxe2.this, Daftar.class);
            startActivity(intent6);
        } else if (itemId == R.id.nav_helpdesk) {
            Intent intent7 = new Intent(Deluxe2.this, Helpdesk.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_about) {
            Intent intent8 = new Intent(Deluxe2.this, About.class);
            startActivity(intent8);
        } else if (itemId == R.id.nav_data_mahasiswa) {
            Intent intent7 = new Intent(Deluxe2.this, DataMahasiswa.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_ubahpass) {
            Intent intent7 = new Intent(Deluxe2.this, UbahPassword.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_daftar_kamar) {
            Intent intent8 = new Intent(Deluxe2.this, DaftarKamar.class);
            startActivity(intent8);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(Deluxe2.this, Login.class);
        startActivity(intent);
        finishAffinity();
    }
