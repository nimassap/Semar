...
public class SliderDeluxe1Adapter extends SliderViewAdapter<SliderDeluxe1Adapter.Holder> {

    private List<String> imageUrls;
    private Context context;
    private OnSliderItemClickListener listener;

    public SliderDeluxe1Adapter(List<String> imageUrls, Context context) {
