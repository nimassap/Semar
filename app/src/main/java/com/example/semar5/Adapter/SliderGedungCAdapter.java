...
public class SliderGedungCAdapter extends SliderViewAdapter<SliderGedungCAdapter.Holder> {

    private List<String> imageUrls;
    private Context context;
    private OnSliderItemClickListener listener;

    public SliderGedungCAdapter(List<String> imageUrls, Context context) {
