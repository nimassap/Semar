...
public class SliderDeluxe5AAdapter extends SliderViewAdapter<SliderDeluxe5AAdapter.Holder> {

    private List<String> imageUrls;
    private Context context;
    private OnSliderItemClickListener listener;

    public SliderDeluxe5AAdapter(List<String> imageUrls, Context context) {
