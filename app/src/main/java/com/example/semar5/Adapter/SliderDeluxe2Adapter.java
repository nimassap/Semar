...
public class SliderDeluxe2Adapter extends SliderViewAdapter<SliderDeluxe2Adapter.Holder> {

    private List<String> imageUrls;
    private Context context;
    private SliderDeluxe2Adapter.OnSliderItemClickListener listener;

    public SliderDeluxe2Adapter(List<String> imageUrls, Context context) {
