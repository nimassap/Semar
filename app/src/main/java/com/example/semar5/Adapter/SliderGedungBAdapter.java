...
public class SliderGedungBAdapter extends SliderViewAdapter<SliderGedungBAdapter.Holder> {

    private List<String> imageUrls;
    private Context context;
    private OnSliderItemClickListener listener;

    public SliderGedungBAdapter(List<String> imageUrls, Context context) {
