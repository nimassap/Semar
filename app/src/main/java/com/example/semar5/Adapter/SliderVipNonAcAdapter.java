...
public class SliderVipNonAcAdapter extends SliderViewAdapter<SliderVipNonAcAdapter.Holder> {

    private List<String> imageUrls;
    private Context context;
    private OnSliderItemClickListener listener;

    public SliderVipNonAcAdapter(List<String> imageUrls, Context context) {
