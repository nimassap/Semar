...
public class SliderDeluxe4Adapter extends SliderViewAdapter<SliderDeluxe4Adapter.Holder> {

    private List<String> imageUrls;
    private Context context;
    private OnSliderItemClickListener listener;

    public SliderDeluxe4Adapter(List<String> imageUrls, Context context) {
