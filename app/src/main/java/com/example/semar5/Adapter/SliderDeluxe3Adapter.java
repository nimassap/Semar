...
public class SliderDeluxe3Adapter extends SliderViewAdapter<SliderDeluxe3Adapter.Holder> {

    private List<String> imageUrls;
    private Context context;
    private OnSliderItemClickListener listener;

    public SliderDeluxe3Adapter(List<String> imageUrls, Context context) {
