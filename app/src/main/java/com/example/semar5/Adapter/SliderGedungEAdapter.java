...
public class SliderGedungEAdapter extends SliderViewAdapter<SliderGedungEAdapter.Holder> {

    private List<String> imageUrls;
    private Context context;
    private OnSliderItemClickListener listener;

    public SliderGedungEAdapter(List<String> imageUrls, Context context) {
