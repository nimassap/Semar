...
public class SliderStandardAdapter extends SliderViewAdapter<SliderStandardAdapter.Holder> {

    private List<String> imageUrls;
    private Context context;
    private OnSliderItemClickListener listener;

    public SliderStandardAdapter(List<String> imageUrls, Context context) {
