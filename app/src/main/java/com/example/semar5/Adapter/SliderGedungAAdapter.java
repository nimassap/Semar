...
public class SliderGedungAAdapter extends SliderViewAdapter<SliderGedungAAdapter.Holder> {

    private List<String> imageUrls;
    private Context context;
    private OnSliderItemClickListener listener;

    public SliderGedungAAdapter(List<String> imageUrls, Context context) {
