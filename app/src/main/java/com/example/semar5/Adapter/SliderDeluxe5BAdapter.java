...
public class SliderDeluxe5BAdapter extends SliderViewAdapter<SliderDeluxe5BAdapter.Holder> {

    private List<String> imageUrls;
    private Context context;
    private OnSliderItemClickListener listener;

    public SliderDeluxe5BAdapter(List<String> imageUrls, Context context) {
