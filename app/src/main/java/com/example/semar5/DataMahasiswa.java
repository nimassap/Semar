...
import com.example.semar5.CRUD.MahasiswaAdapter;
...
public class DataMahasiswa extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intenttoolbar = new Intent(DataMahasiswa.this, MainActivity.class);
        ...
        TextView tambahdata = findViewById(R.id.tambah_datamhs);
        tambahdata.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DataMahasiswa.this, DataMahasiswaTambah.class);
        ...
        //list data mahasiswa
        recyclerView = findViewById(R.id.recylerview_datamhs);
    ...
    //memanggil data mahasiswa dari database
    private void fetchDataMahasiswa() {
        RetrofitClient retrofitClient = RetrofitClient.getInstance(this);
        Api apiService = retrofitClient.getApi();

        Call<MahasiswaResponse> call = apiService.getMahasiswaData();
        call.enqueue(new Callback<MahasiswaResponse>() {
            ...
            public void onResponse(Call<MahasiswaResponse> call, Response<MahasiswaResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    MahasiswaResponse mahasiswaResponse = response.body();
                    List<Mahasiswa> mahasiswaList = mahasiswaResponse.getMahasiswaList();
                    List<Mahasiswa> filteredMahasiswaList = filterMahasiswaByRole(mahasiswaList, 2);
                    setupRecyclerView(filteredMahasiswaList);
                }
            }
            ...
            public void onFailure(Call<MahasiswaResponse> call, Throwable t) {
                ...
                Toast.makeText(DataMahasiswa.this, "Kesalahan Jaringan. Gagal mengambil data", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private List<Mahasiswa> filterMahasiswaByRole(List<Mahasiswa> mahasiswaList, int targetRole) {
        List<Mahasiswa> filteredList = new ArrayList<>();
        for (Mahasiswa mahasiswa : mahasiswaList) {
            if (mahasiswa.getIdRole() == targetRole) {
    ...
    //memanggil adapter recyclerview
    private void setupRecyclerView(List<Mahasiswa> mahasiswaList) {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_home) {
            ...
            Intent intent1 = new Intent(DataMahasiswa.this, GaleriActivity.class);
            startActivity(intent1);
        } else if (itemId == R.id.nav_carabooking) {
            Intent intent2 = new Intent(DataMahasiswa.this, CaraDaftarActivity.class);
            startActivity(intent2);
        } else if (itemId == R.id.nav_snk) {
            Intent intent3 = new Intent(DataMahasiswa.this, SnKActivity.class);
            startActivity(intent3);
        } else if (itemId == R.id.nav_login) {
            Intent intent4 = new Intent(DataMahasiswa.this, Login.class);
            startActivity(intent4);
        } else if (itemId == R.id.nav_daftar) {
            Intent intent5 = new Intent(DataMahasiswa.this, Daftar.class);
            startActivity(intent5);
        } else if (itemId == R.id.nav_helpdesk) {
            Intent intent6 = new Intent(DataMahasiswa.this, Helpdesk.class);
            startActivity(intent6);
        } else if (itemId == R.id.nav_about) {
            Intent intent7 = new Intent(DataMahasiswa.this, About.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_data_mahasiswa) {
            Intent intent7 = new Intent(DataMahasiswa.this, DataMahasiswa.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_ubahpass) {
            Intent intent7 = new Intent(DataMahasiswa.this, UbahPassword.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_daftar_kamar) {
            Intent intent8 = new Intent(DataMahasiswa.this, DaftarKamar.class);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(DataMahasiswa.this, Login.class);
        startActivity(intent);
        finishAffinity();
    }
