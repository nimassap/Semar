...
public class GedungBEdit extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gedung_b_edit);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GedungBEdit.this, MainActivity.class);
        ...
        //sesuaikan activity
        drawerLayout = findViewById(R.id.drawer_layout_gedungbedit);
        navigationView = findViewById(R.id.navdrawer_view);
        ...
        Button saveEdit = findViewById(R.id.save_gedungb);
    ...
    private void tampilDataGedungB() {

        EditText tvGedungB_1 = findViewById(R.id.tv_gedungb_1);
        EditText tvGedungB_2 = findViewById(R.id.tv_gedungb_2);
        EditText tvGedungB_3 = findViewById(R.id.tv_gedungb_3);
        EditText tvGedungB_4 = findViewById(R.id.tv_gedungb_4);

        RetrofitClient retrofitClient = RetrofitClient.getInstance(this);
        Api api = retrofitClient.getApi();

        Call<List<TampilGedungB>> call = api.getDataGedungB();
        call.enqueue(new Callback<List<TampilGedungB>>() {
            @Override
                        ...
                        for (TampilGedungB item : dataItems) {
                            switch (item.getId()) {
                                ...
                                case 2:
                                    ...
                                    break;
                                case 3:
                                    tvGedungB_3.setText(item.getTextEdit());
                                    break;
                                case 4:
                                    tvGedungB_4.setText(item.getTextEdit());
                                    break;
                            }
                        }
                    } else {
                        Toast.makeText(GedungBEdit.this, "No data available", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(GedungBEdit.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<TampilGedungB>> call, Throwable t) {
                Toast.makeText(GedungBEdit.this, "Network error", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void editDataGedungB() {
        ...
        String editText1 = tvGedungB_1.getText().toString();
        String editText2 = tvGedungB_2.getText().toString();
        String editText3 = tvGedungB_3.getText().toString();
        String editText4 = tvGedungB_4.getText().toString();

        RetrofitClient retrofitClient = RetrofitClient.getInstance(this);
        Api api = retrofitClient.getApi();

        Call<UpdateGedungB> call1 = api.updateDataGedungB(1, editText1);
        Call<UpdateGedungB> call2 = api.updateDataGedungB(2, editText2);
        Call<UpdateGedungB> call3 = api.updateDataGedungB(3, editText3);
        Call<UpdateGedungB> call4 = api.updateDataGedungB(4, editText4);
    ...
    private final Callback<UpdateGedungB> updateResponseCallback = new Callback<UpdateGedungB>() {
        @Override
        public void onResponse(Call<UpdateGedungB> call, Response<UpdateGedungB> response) {
            if (response.isSuccessful()) {
                UpdateGedungB updateGedungB = response.body();
                String status = updateGedungB.getStatus();
                String message = updateGedungB.getMessage();
                if (status.equals("success")) {
                    successCount++;
                } else if (status.equals("error")) {
                    Toast.makeText(GedungBEdit.this, "Gagal Memperbarui Data" + message, Toast.LENGTH_SHORT).show();
                    failureCount++;
                }

                if (successCount + failureCount == 9) {
                    Toast.makeText(GedungBEdit.this, "Data Berhasil Diperbarui", Toast.LENGTH_SHORT).show();
                    successCount = 0;
                    failureCount = 0;

                    Intent intent = new Intent(GedungBEdit.this, GedungB.class);
                    startActivity(intent);
                }

            } else {
                Toast.makeText(GedungBEdit.this, "Error" + response.message(), Toast.LENGTH_SHORT).show();
                failureCount++;
        ...
        @Override
        public void onFailure(Call<UpdateGedungB> call, Throwable t) {
            Toast.makeText(GedungBEdit.this, "Kesalahan jaringan" + t.getMessage(), Toast.LENGTH_SHORT).show();
            failureCount++;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_home) {
            Intent intent1 = new Intent(GedungBEdit.this, MainActivity.class);
            startActivity(intent1);
        } else if (itemId == R.id.nav_carabooking) {
            Intent intent2 = new Intent(GedungBEdit.this, CaraDaftarActivity.class);
            startActivity(intent2);
        } else if (itemId == R.id.nav_galeri) {
            Intent intent3 = new Intent(GedungBEdit.this, GaleriActivity.class);
            startActivity(intent3);
        } else if (itemId == R.id.nav_snk) {
            Intent intent4 = new Intent(GedungBEdit.this, SnKActivity.class);
            startActivity(intent4);
        } else if (itemId == R.id.nav_login) {
            Intent intent5 = new Intent(GedungBEdit.this, Login.class);
            startActivity(intent5);
        } else if (itemId == R.id.nav_daftar) {
            Intent intent6 = new Intent(GedungBEdit.this, Daftar.class);
            startActivity(intent6);
        } else if (itemId == R.id.nav_helpdesk) {
            Intent intent7 = new Intent(GedungBEdit.this, Helpdesk.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_about) {
            Intent intent8 = new Intent(GedungBEdit.this, About.class);
            startActivity(intent8);
        } else if (itemId == R.id.nav_data_mahasiswa) {
            Intent intent7 = new Intent(GedungBEdit.this, DataMahasiswa.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_ubahpass) {
            Intent intent7 = new Intent(GedungBEdit.this, UbahPassword.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_daftar_kamar) {
            Intent intent8 = new Intent(GedungBEdit.this, DaftarKamar.class);
            startActivity(intent8);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(GedungBEdit.this, Login.class);
        startActivity(intent);
        finishAffinity();
    }
}