...
public class NotifikasiAdminActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private User user;
    private NotificationAdapterAdmin notificationAdapterAdmin;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_notifikasi_admin);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(NotifikasiAdminActivity.this, MainActivity.class);
        ...
        RecyclerView recyclerView = findViewById(R.id.recylerview_notifikasi_admin);
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (pemesananResponse.getError().equals("200")) {
                        ...
                        if (!pemesananList.isEmpty()) {
                            Collections.sort(pemesananList, new Comparator<Pemesanan>() {
                                @Override
                                public int compare(Pemesanan p1, Pemesanan p2) {
                                    return p2.getTanggalMasuk().compareTo(p1.getTanggalMasuk());
                                }
                            });

                            NotificationAdapterAdmin adapter = new NotificationAdapterAdmin(pemesananList);
                            adapter.setOnItemClickListener(new NotificationAdapterAdmin.OnItemClickListener() {
                                @Override
                                public void onItemClick(Pemesanan pemesanan) {
                                    Intent intent = new Intent(NotifikasiAdminActivity.this, HistoryActivity.class);
                                    startActivity(intent);
                                }
                            });
        ...
        //sesuaikan activity
        drawerLayout = findViewById(R.id.drawer_layout_notifikasi_admin);
        navigationView = findViewById(R.id.navdrawer_view);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_home) {
            Intent intent1 = new Intent(NotifikasiAdminActivity.this, MainActivity.class);
            startActivity(intent1);
        } else if (itemId == R.id.nav_carabooking) {
            Intent intent2 = new Intent(NotifikasiAdminActivity.this, CaraDaftarActivity.class);
            startActivity(intent2);
        } else if (itemId == R.id.nav_galeri) {
            Intent intent3 = new Intent(NotifikasiAdminActivity.this, GaleriActivity.class);
            startActivity(intent3);
        } else if (itemId == R.id.nav_snk) {
            Intent intent4 = new Intent(NotifikasiAdminActivity.this, SnKActivity.class);
            startActivity(intent4);
        } else if (itemId == R.id.nav_login) {
            Intent intent5 = new Intent(NotifikasiAdminActivity.this, Login.class);
            startActivity(intent5);
        } else if (itemId == R.id.nav_daftar) {
            Intent intent6 = new Intent(NotifikasiAdminActivity.this, Daftar.class);
            startActivity(intent6);
        } else if (itemId == R.id.nav_helpdesk) {
            Intent intent7 = new Intent(NotifikasiAdminActivity.this, Helpdesk.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_about) {
            Intent intent8 = new Intent(NotifikasiAdminActivity.this, About.class);
            startActivity(intent8);
        } else if (itemId == R.id.nav_data_mahasiswa) {
            Intent intent7 = new Intent(NotifikasiAdminActivity.this, DataMahasiswa.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_ubahpass) {
            Intent intent7 = new Intent(NotifikasiAdminActivity.this, UbahPassword.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_daftar_kamar) {
            Intent intent8 = new Intent(NotifikasiAdminActivity.this, DaftarKamar.class);
            startActivity(intent8);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(NotifikasiAdminActivity.this, Login.class);
        startActivity(intent);
        finishAffinity();
    }
}