...
public class Deluxe1Edit extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deluxe1_edit);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Deluxe1Edit.this, MainActivity.class);
        ...
        //sesuaikan activity
        drawerLayout = findViewById(R.id.drawer_layout_deluxe1edit);
        navigationView = findViewById(R.id.navdrawer_view);
        ...
        Button saveEdit = findViewById(R.id.save_deluxe1);
    ...
    private void tampilDataDeluxe1() {

        EditText tvDeluxe1_1 = findViewById(R.id.et_deluxe1_1);
        EditText tvDeluxe1_2 = findViewById(R.id.et_deluxe1_2);
        EditText tvDeluxe1_3 = findViewById(R.id.et_deluxe1_3);
        EditText tvDeluxe1_4 = findViewById(R.id.et_deluxe1_4);
        EditText tvDeluxe1_5 = findViewById(R.id.et_deluxe1_5);
        EditText tvDeluxe1_6 = findViewById(R.id.et_deluxe1_6);
        EditText tvDeluxe1_7 = findViewById(R.id.et_deluxe1_7);
        EditText tvDeluxe1_8 = findViewById(R.id.et_deluxe1_8);
        EditText tvDeluxe1_9 = findViewById(R.id.et_deluxe1_9);

        RetrofitClient retrofitClient = RetrofitClient.getInstance(this);
        Api api = retrofitClient.getApi();

        Call<List<TampilDeluxe1>> call = api.getDataDeluxe1();
            ...
            public void onResponse(Call<List<TampilDeluxe1>> call, Response<List<TampilDeluxe1>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (dataItems != null && !dataItems.isEmpty()) {
                        ...
                        Toast.makeText(Deluxe1Edit.this, "No data available", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(Deluxe1Edit.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<TampilDeluxe1>> call, Throwable t) {
                Toast.makeText(Deluxe1Edit.this, "Network error", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void editDataDeluxe1() {
        ...
        String editText1 = tvDeluxe1_1.getText().toString();
        String editText2 = tvDeluxe1_2.getText().toString();
        String editText3 = tvDeluxe1_3.getText().toString();
        String editText4 = tvDeluxe1_4.getText().toString();
        String editText5 = tvDeluxe1_5.getText().toString();
        String editText6 = tvDeluxe1_6.getText().toString();
        String editText7 = tvDeluxe1_7.getText().toString();
        String editText8 = tvDeluxe1_8.getText().toString();
        String editText9 = tvDeluxe1_9.getText().toString();

        RetrofitClient retrofitClient = RetrofitClient.getInstance(this);
        Api api = retrofitClient.getApi();

        Call<UpdateDeluxe1> call1 = api.updateDataDeluxe1(1, editText1);
        Call<UpdateDeluxe1> call2 = api.updateDataDeluxe1(2, editText2);
        Call<UpdateDeluxe1> call3 = api.updateDataDeluxe1(3, editText3);
        Call<UpdateDeluxe1> call4 = api.updateDataDeluxe1(4, editText4);
        Call<UpdateDeluxe1> call5 = api.updateDataDeluxe1(5, editText5);
        Call<UpdateDeluxe1> call6 = api.updateDataDeluxe1(6, editText6);
        Call<UpdateDeluxe1> call7 = api.updateDataDeluxe1(7, editText7);
        Call<UpdateDeluxe1> call8 = api.updateDataDeluxe1(8, editText8);
        Call<UpdateDeluxe1> call9 = api.updateDataDeluxe1(9, editText9);
    ...
    private final Callback<UpdateDeluxe1> updateResponseCallback = new Callback<UpdateDeluxe1>() {
        @Override
        public void onResponse(Call<UpdateDeluxe1> call, Response<UpdateDeluxe1> response) {
            if (response.isSuccessful()) {
                UpdateDeluxe1 updateDeluxe1 = response.body();
                String status = updateDeluxe1.getStatus();
                String message = updateDeluxe1.getMessage();
                if (status.equals("success")) {
                    successCount++;
                } else if (status.equals("error")) {
                    Toast.makeText(Deluxe1Edit.this, "Gagal Memperbarui Data" + message, Toast.LENGTH_SHORT).show();
                    failureCount++;
                }

                if (successCount + failureCount == 9) {
                    Toast.makeText(Deluxe1Edit.this, "Data Berhasil Diperbarui", Toast.LENGTH_SHORT).show();
                    successCount = 0;
                    failureCount = 0;

                    Intent intent = new Intent(Deluxe1Edit.this, Deluxe1.class);
                    startActivity(intent);
                }

            } else {
                Toast.makeText(Deluxe1Edit.this, "Error" + response.message(), Toast.LENGTH_SHORT).show();
                failureCount++;
        ...
        @Override
        public void onFailure(Call<UpdateDeluxe1> call, Throwable t) {
            Toast.makeText(Deluxe1Edit.this, "Kesalahan jaringan" + t.getMessage(), Toast.LENGTH_SHORT).show();
            failureCount++;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_home) {
            Intent intent1 = new Intent(Deluxe1Edit.this, MainActivity.class);
            startActivity(intent1);
        } else if (itemId == R.id.nav_carabooking) {
            Intent intent2 = new Intent(Deluxe1Edit.this, CaraDaftarActivity.class);
            startActivity(intent2);
        } else if (itemId == R.id.nav_galeri) {
            Intent intent3 = new Intent(Deluxe1Edit.this, GaleriActivity.class);
            startActivity(intent3);
        } else if (itemId == R.id.nav_snk) {
            Intent intent4 = new Intent(Deluxe1Edit.this, SnKActivity.class);
            startActivity(intent4);
        } else if (itemId == R.id.nav_login) {
            Intent intent5 = new Intent(Deluxe1Edit.this, Login.class);
            startActivity(intent5);
        } else if (itemId == R.id.nav_daftar) {
            Intent intent6 = new Intent(Deluxe1Edit.this, Daftar.class);
            startActivity(intent6);
        } else if (itemId == R.id.nav_helpdesk) {
            Intent intent7 = new Intent(Deluxe1Edit.this, Helpdesk.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_about) {
            Intent intent8 = new Intent(Deluxe1Edit.this, About.class);
            startActivity(intent8);
        } else if (itemId == R.id.nav_data_mahasiswa) {
            Intent intent7 = new Intent(Deluxe1Edit.this, DataMahasiswa.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_ubahpass) {
            Intent intent7 = new Intent(Deluxe1Edit.this, UbahPassword.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_daftar_kamar) {
            Intent intent8 = new Intent(Deluxe1Edit.this, DaftarKamar.class);
            startActivity(intent8);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(Deluxe1Edit.this, Login.class);
        startActivity(intent);
        finishAffinity();
    }
