...
import com.example.semar5.Adapter.SliderVipAcAdapter;
...
public class VipAc extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vip_ac);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(VipAc.this, MainActivity.class);
        ...
        Call<List<String>> call1 = api.getGambarVipAc();
        ...
        call1.enqueue(new Callback<List<String>>() {
            ...
            public void onResponse(Call<List<String>> call, Response<List<String>> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(VipAc.this, "Error", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<String>> call, Throwable t) {
                ...
                Toast.makeText(VipAc.this, "Kesalahan jaringan", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        //sesuaikan activity
        drawerLayout = findViewById(R.id.drawer_layout_vipac);
        navigationView = findViewById(R.id.navdrawer_view);
        ...
        Call<List<TampilVipAc>> call = api1.getDataVipAc();
            ...
            public void onResponse(Call<List<TampilVipAc>> call, Response<List<TampilVipAc>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (dataItems != null && !dataItems.isEmpty()) {
                        ...
                        TextView tvVipAC_3 = findViewById(R.id.tv_vipac_3);
                        TextView tvVipAC_4 = findViewById(R.id.tv_vipac_4);
                        TextView tvVipAC_5 = findViewById(R.id.tv_vipac_5);
                        TextView tvVipAC_6 = findViewById(R.id.tv_vipac_6);
                        TextView tvVipAC_7 = findViewById(R.id.tv_vipac_7);
                        TextView tvVipAC_8 = findViewById(R.id.tv_vipac_8);
                        TextView tvVipAC_9 = findViewById(R.id.tv_vipac_9);
                        ...
                        Toast.makeText(VipAc.this, "Data tidak tersedia", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Log.e("API_CALL", "onResponse - Error: " + response.code());
                    Toast.makeText(VipAc.this, "Gagal mengambil data", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void displayImages(List<String> imageUrls) {
        //image slider
        sliderView = findViewById(R.id.image_slider_vipac);

        SliderVipAcAdapter sliderAdapter = new SliderVipAcAdapter(imageUrls, VipAc.this);
        ...
        sliderAdapter.setOnSliderItemClickListener(new SliderVipAcAdapter.OnSliderItemClickListener() {
            @Override
            public void onSliderItemClick(int position) {
                Intent intent = new Intent(VipAc.this, ViewSliderPicVipAc.class);
    ...
    protected void onStart() {
        ...
        Button edit = findViewById(R.id.edit_vipac);
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(VipAc.this, VipAcEdit.class);
                startActivity(intent);
            }
        });

        //button pindah activity ke pendaftaran kamar
        Button buttbookingnow = findViewById(R.id.booknow_vipac);
        buttbookingnow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(VipAc.this, BookingSekarang.class);
                startActivity(intent);
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_home) {
            Intent intent1 = new Intent(VipAc.this, MainActivity.class);
            startActivity(intent1);
        } else if (itemId == R.id.nav_carabooking) {
            Intent intent2 = new Intent(VipAc.this, CaraDaftarActivity.class);
            startActivity(intent2);
        } else if (itemId == R.id.nav_galeri) {
            Intent intent3 = new Intent(VipAc.this, GaleriActivity.class);
            startActivity(intent3);
        } else if (itemId == R.id.nav_snk) {
            Intent intent4 = new Intent(VipAc.this, SnKActivity.class);
            startActivity(intent4);
        } else if (itemId == R.id.nav_login) {
            Intent intent5 = new Intent(VipAc.this, Login.class);
            startActivity(intent5);
        } else if (itemId == R.id.nav_daftar) {
            Intent intent6 = new Intent(VipAc.this, Daftar.class);
            startActivity(intent6);
        } else if (itemId == R.id.nav_helpdesk) {
            Intent intent7 = new Intent(VipAc.this, Helpdesk.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_about) {
            Intent intent8 = new Intent(VipAc.this, About.class);
            startActivity(intent8);
        } else if (itemId == R.id.nav_data_mahasiswa) {
            Intent intent7 = new Intent(VipAc.this, DataMahasiswa.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_ubahpass) {
            Intent intent7 = new Intent(VipAc.this, UbahPassword.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_daftar_kamar) {
            Intent intent8 = new Intent(VipAc.this, DaftarKamar.class);
            startActivity(intent8);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(VipAc.this, Login.class);
        startActivity(intent);
        finishAffinity();
    }
