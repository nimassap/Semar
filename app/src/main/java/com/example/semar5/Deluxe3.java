...
public class Deluxe3 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deluxe3);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Deluxe3.this, MainActivity.class);
        ...
        Call<List<String>> call1 = api.getGambarDeluxe3();
        ...
        call1.enqueue(new Callback<List<String>>() {
            ...
            public void onResponse(Call<List<String>> call, Response<List<String>> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(Deluxe3.this, "Error", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<String>> call, Throwable t) {
                ...
                Toast.makeText(Deluxe3.this, "Kesalahan jaringan", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        //sesuaikan activity
        drawerLayout = findViewById(R.id.drawer_layout_deluxe3);
        navigationView = findViewById(R.id.navdrawer_view);
        ...
        Call<List<TampilDeluxe3>> call = api1.getDataDeluxe3();
            ...
            public void onResponse(Call<List<TampilDeluxe3>> call, Response<List<TampilDeluxe3>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (dataItems != null && !dataItems.isEmpty()) {
                        ...
                        TextView tvDeluxe3_3 = findViewById(R.id.tv_deluxe3_3);
                        TextView tvDeluxe3_4 = findViewById(R.id.tv_deluxe3_4);
                        TextView tvDeluxe3_5 = findViewById(R.id.tv_deluxe3_5);
                        TextView tvDeluxe3_6 = findViewById(R.id.tv_deluxe3_6);
                        TextView tvDeluxe3_7 = findViewById(R.id.tv_deluxe3_7);
                        TextView tvDeluxe3_8 = findViewById(R.id.tv_deluxe3_8);
                        TextView tvDeluxe3_9 = findViewById(R.id.tv_deluxe3_9);
                        ...
                        Toast.makeText(Deluxe3.this, "Data tidak tersedia", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Log.e("API_CALL", "onResponse - Error: " + response.code());
                    Toast.makeText(Deluxe3.this, "Gagal mengambil data", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void displayImages(List<String> imageUrls) {
        //image slider
        sliderView = findViewById(R.id.image_slider_deluxe3);

        SliderDeluxe3Adapter sliderAdapter = new SliderDeluxe3Adapter(imageUrls, Deluxe3.this);
        ...
        sliderAdapter.setOnSliderItemClickListener(new SliderDeluxe3Adapter.OnSliderItemClickListener() {
            @Override
            public void onSliderItemClick(int position) {
                Intent intent = new Intent(Deluxe3.this, ViewSliderPicDeluxe3.class);
    ...
    protected void onStart() {
        ...
        Button edit = findViewById(R.id.edit_deluxe3);
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Deluxe3.this, Deluxe3Edit.class);
                startActivity(intent);
            }
        });

        //button pindah activity ke pendaftaran kamar
        Button buttbookingnow = findViewById(R.id.booknow_deluxe3);
        buttbookingnow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Deluxe3.this, BookingSekarang.class);
                startActivity(intent);
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_home) {
            Intent intent1 = new Intent(Deluxe3.this, MainActivity.class);
            startActivity(intent1);
        } else if (itemId == R.id.nav_carabooking) {
            Intent intent2 = new Intent(Deluxe3.this, CaraDaftarActivity.class);
            startActivity(intent2);
        } else if (itemId == R.id.nav_galeri) {
            Intent intent3 = new Intent(Deluxe3.this, GaleriActivity.class);
            startActivity(intent3);
        } else if (itemId == R.id.nav_snk) {
            Intent intent4 = new Intent(Deluxe3.this, SnKActivity.class);
            startActivity(intent4);
        } else if (itemId == R.id.nav_login) {
            Intent intent5 = new Intent(Deluxe3.this, Login.class);
            startActivity(intent5);
        } else if (itemId == R.id.nav_daftar) {
            Intent intent6 = new Intent(Deluxe3.this, Daftar.class);
            startActivity(intent6);
        } else if (itemId == R.id.nav_helpdesk) {
            Intent intent7 = new Intent(Deluxe3.this, Helpdesk.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_about) {
            Intent intent8 = new Intent(Deluxe3.this, About.class);
            startActivity(intent8);
        } else if (itemId == R.id.nav_data_mahasiswa) {
            Intent intent7 = new Intent(Deluxe3.this, DataMahasiswa.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_ubahpass) {
            Intent intent7 = new Intent(Deluxe3.this, UbahPassword.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_daftar_kamar) {
            Intent intent8 = new Intent(Deluxe3.this, DaftarKamar.class);
            startActivity(intent8);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(Deluxe3.this, Login.class);
        startActivity(intent);
        finishAffinity();
    }
