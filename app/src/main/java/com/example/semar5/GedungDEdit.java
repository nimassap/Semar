...
public class GedungDEdit extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gedung_d_edit);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GedungDEdit.this, MainActivity.class);
        ...
        //sesuaikan activity
        drawerLayout = findViewById(R.id.drawer_layout_gedungdedit);
        navigationView = findViewById(R.id.navdrawer_view);
        ...
        Button saveEdit = findViewById(R.id.save_gedungd);
    ...
    private void tampilDataGedungD() {

        EditText tvGedungD_1 = findViewById(R.id.tv_gedungd_1);
        EditText tvGedungD_2 = findViewById(R.id.tv_gedungd_2);
        EditText tvGedungD_3 = findViewById(R.id.tv_gedungd_3);
        EditText tvGedungD_4 = findViewById(R.id.tv_gedungd_4);
        EditText tvGedungD_5 = findViewById(R.id.tv_gedungd_5);
        EditText tvGedungD_6 = findViewById(R.id.tv_gedungd_6);
        EditText tvGedungD_7 = findViewById(R.id.tv_gedungd_7);

        RetrofitClient retrofitClient = RetrofitClient.getInstance(this);
        Api api = retrofitClient.getApi();

        Call<List<TampilGedungD>> call = api.getDataGedungD();
        call.enqueue(new Callback<List<TampilGedungD>>() {
            @Override
                        ...
                        for (TampilGedungD item : dataItems) {
                            switch (item.getId()) {
                                ...
                                case 2:
                                    ...
                                    break;
                                case 3:
                                    tvGedungD_3.setText(item.getTextEdit());
                                    break;
                                case 4:
                                    tvGedungD_4.setText(item.getTextEdit());
                                    break;
                                case 5:
                                    tvGedungD_5.setText(item.getTextEdit());
                                    break;
                                case 6:
                                    tvGedungD_6.setText(item.getTextEdit());
                                    break;
                                case 7:
                                    tvGedungD_7.setText(item.getTextEdit());
                                    break;
                            }
                        }
                    } else {
                        Toast.makeText(GedungDEdit.this, "No data available", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(GedungDEdit.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<TampilGedungD>> call, Throwable t) {
                Toast.makeText(GedungDEdit.this, "Network error", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void editDataGedungD() {
        ...
        String editText1 = tvGedungD_1.getText().toString();
        String editText2 = tvGedungD_2.getText().toString();
        String editText3 = tvGedungD_3.getText().toString();
        String editText4 = tvGedungD_4.getText().toString();
        String editText5 = tvGedungD_5.getText().toString();
        String editText6 = tvGedungD_6.getText().toString();
        String editText7 = tvGedungD_7.getText().toString();

        RetrofitClient retrofitClient = RetrofitClient.getInstance(this);
        Api api = retrofitClient.getApi();

        Call<UpdateGedungD> call1 = api.updateDataGedungD(1, editText1);
        Call<UpdateGedungD> call2 = api.updateDataGedungD(2, editText2);
        Call<UpdateGedungD> call3 = api.updateDataGedungD(3, editText3);
        Call<UpdateGedungD> call4 = api.updateDataGedungD(4, editText4);
        Call<UpdateGedungD> call5 = api.updateDataGedungD(5, editText5);
        Call<UpdateGedungD> call6 = api.updateDataGedungD(6, editText6);
        Call<UpdateGedungD> call7 = api.updateDataGedungD(7, editText7);
    ...
    private final Callback<UpdateGedungD> updateResponseCallback = new Callback<UpdateGedungD>() {
        @Override
        public void onResponse(Call<UpdateGedungD> call, Response<UpdateGedungD> response) {
            if (response.isSuccessful()) {
                UpdateGedungD updateGedungD = response.body();
                String status = updateGedungD.getStatus();
                String message = updateGedungD.getMessage();
                if (status.equals("success")) {
                    successCount++;
                } else if (status.equals("error")) {
                    Toast.makeText(GedungDEdit.this, "Gagal Memperbarui Data" + message, Toast.LENGTH_SHORT).show();
                    failureCount++;
                }

                if (successCount + failureCount == 9) {
                    Toast.makeText(GedungDEdit.this, "Data Berhasil Diperbarui", Toast.LENGTH_SHORT).show();
                    successCount = 0;
                    failureCount = 0;

                    Intent intent = new Intent(GedungDEdit.this, GedungD.class);
                    startActivity(intent);
                }

            } else {
                Toast.makeText(GedungDEdit.this, "Error" + response.message(), Toast.LENGTH_SHORT).show();
                failureCount++;
        ...
        @Override
        public void onFailure(Call<UpdateGedungD> call, Throwable t) {
            Toast.makeText(GedungDEdit.this, "Kesalahan jaringan" + t.getMessage(), Toast.LENGTH_SHORT).show();
            failureCount++;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_home) {
            Intent intent1 = new Intent(GedungDEdit.this, MainActivity.class);
            startActivity(intent1);
        } else if (itemId == R.id.nav_carabooking) {
            Intent intent2 = new Intent(GedungDEdit.this, CaraDaftarActivity.class);
            startActivity(intent2);
        } else if (itemId == R.id.nav_galeri) {
            Intent intent3 = new Intent(GedungDEdit.this, GaleriActivity.class);
            startActivity(intent3);
        } else if (itemId == R.id.nav_snk) {
            Intent intent4 = new Intent(GedungDEdit.this, SnKActivity.class);
            startActivity(intent4);
        } else if (itemId == R.id.nav_login) {
            Intent intent5 = new Intent(GedungDEdit.this, Login.class);
            startActivity(intent5);
        } else if (itemId == R.id.nav_daftar) {
            Intent intent6 = new Intent(GedungDEdit.this, Daftar.class);
            startActivity(intent6);
        } else if (itemId == R.id.nav_helpdesk) {
            Intent intent7 = new Intent(GedungDEdit.this, Helpdesk.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_about) {
            Intent intent8 = new Intent(GedungDEdit.this, About.class);
            startActivity(intent8);
        } else if (itemId == R.id.nav_data_mahasiswa) {
            Intent intent7 = new Intent(GedungDEdit.this, DataMahasiswa.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_ubahpass) {
            Intent intent7 = new Intent(GedungDEdit.this, UbahPassword.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_daftar_kamar) {
            Intent intent8 = new Intent(GedungDEdit.this, DaftarKamar.class);
            startActivity(intent8);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(GedungDEdit.this, Login.class);
        startActivity(intent);
        finishAffinity();
    }
}