...
import com.example.semar5.Adapter.SliderGedungEAdapter;
...
public class GedungE extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gedung_e);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GedungE.this, MainActivity.class);
        ...
        Call<List<String>> call1 = api.getGambarGedungE();
        ...
        call1.enqueue(new Callback<List<String>>() {
            ...
            public void onResponse(Call<List<String>> call, Response<List<String>> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(GedungE.this, "Error", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<String>> call, Throwable t) {
                ...
                Toast.makeText(GedungE.this, "Kesalahan jaringan", Toast.LENGTH_SHORT).show();
            }
        });


        //sesuaikan activity
        drawerLayout = findViewById(R.id.drawer_layout_gedunge);
        navigationView = findViewById(R.id.navdrawer_view);
        ...
        Call<List<TampilGedungE>> call = api1.getDataGedungE();
            ...
            public void onResponse(Call<List<TampilGedungE>> call, Response<List<TampilGedungE>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (dataItems != null && !dataItems.isEmpty()) {
                        ...
                        TextView tvGedungE_3 = findViewById(R.id.tv_gedunge_3);
                        TextView tvGedungE_4 = findViewById(R.id.tv_gedunge_4);
                        TextView tvGedungE_5 = findViewById(R.id.tv_gedunge_5);
                        TextView tvGedungE_6 = findViewById(R.id.tv_gedunge_6);
                        TextView tvGedungE_7 = findViewById(R.id.tv_gedunge_7);
                        TextView tvGedungE_8 = findViewById(R.id.tv_gedunge_8);
                        TextView tvGedungE_9 = findViewById(R.id.tv_gedunge_9);
                        TextView tvGedungE_10 = findViewById(R.id.tv_gedunge_10);
                        TextView tvGedungE_11 = findViewById(R.id.tv_gedunge_11);
                        TextView tvGedungE_12 = findViewById(R.id.tv_gedunge_12);
                        TextView tvGedungE_13 = findViewById(R.id.tv_gedunge_13);
                        TextView tvGedungE_14 = findViewById(R.id.tv_gedunge_14);
                        TextView tvGedungE_15 = findViewById(R.id.tv_gedunge_15);
                        TextView tvGedungE_16 = findViewById(R.id.tv_gedunge_16);
                        ...
                        Toast.makeText(GedungE.this, "Data tidak tersedia", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Log.e("API_CALL", "onResponse - Error: " + response.code());
                    Toast.makeText(GedungE.this, "Gagal mengambil data", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void displayImages(List<String> imageUrls) {
        //image slider
        sliderView = findViewById(R.id.image_slider_gedunge);

        SliderGedungEAdapter sliderAdapter = new SliderGedungEAdapter(imageUrls, GedungE.this);
        ...
        sliderAdapter.setOnSliderItemClickListener(new SliderGedungEAdapter.OnSliderItemClickListener() {
            @Override
            public void onSliderItemClick(int position) {
                Intent intent = new Intent(GedungE.this, ViewSliderPicGedungE.class);
    ...
    protected void onStart() {
        ...
        Button edit = findViewById(R.id.edit_gedunge);
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GedungE.this, GedungEEdit.class);
                startActivity(intent);
            }
        });

        //button pindah activity ke pendaftaran kamar
        Button buttbookingnow = findViewById(R.id.booknow_gedunge);
        buttbookingnow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GedungE.this, BookingSekarang.class);
                startActivity(intent);
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_home) {
            Intent intent1 = new Intent(GedungE.this, MainActivity.class);
            startActivity(intent1);
        } else if (itemId == R.id.nav_carabooking) {
            Intent intent2 = new Intent(GedungE.this, CaraDaftarActivity.class);
            startActivity(intent2);
        } else if (itemId == R.id.nav_galeri) {
            Intent intent3 = new Intent(GedungE.this, GaleriActivity.class);
            startActivity(intent3);
        } else if (itemId == R.id.nav_snk) {
            Intent intent4 = new Intent(GedungE.this, SnKActivity.class);
            startActivity(intent4);
        } else if (itemId == R.id.nav_login) {
            Intent intent5 = new Intent(GedungE.this, Login.class);
            startActivity(intent5);
        } else if (itemId == R.id.nav_daftar) {
            Intent intent6 = new Intent(GedungE.this, Daftar.class);
            startActivity(intent6);
        } else if (itemId == R.id.nav_helpdesk) {
            Intent intent7 = new Intent(GedungE.this, Helpdesk.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_about) {
            Intent intent8 = new Intent(GedungE.this, About.class);
            startActivity(intent8);
        } else if (itemId == R.id.nav_data_mahasiswa) {
            Intent intent7 = new Intent(GedungE.this, DataMahasiswa.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_ubahpass) {
            Intent intent7 = new Intent(GedungE.this, UbahPassword.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_daftar_kamar) {
            Intent intent8 = new Intent(GedungE.this, DaftarKamar.class);
            startActivity(intent8);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(GedungE.this, Login.class);
        startActivity(intent);
        finishAffinity();
    }
