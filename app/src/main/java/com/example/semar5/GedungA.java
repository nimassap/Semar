...
public class GedungA extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GedungA.this, MainActivity.class);
        ...
        Call<List<String>> call1 = api.getGambarGedungA();
        ...
        call1.enqueue(new Callback<List<String>>() {
            ...
            public void onResponse(Call<List<String>> call, Response<List<String>> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(GedungA.this, "Error", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<String>> call, Throwable t) {
                ...
                Toast.makeText(GedungA.this, "Kesalahan jaringan", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        //sesuaikan activity
        drawerLayout = findViewById(R.id.drawer_layout_gedunga);
        navigationView = findViewById(R.id.navdrawer_view);
        ...
        Call<List<TampilGedungA>> call = api1.getDataGedungA();
            ...
            public void onResponse(Call<List<TampilGedungA>> call, Response<List<TampilGedungA>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (dataItems != null && !dataItems.isEmpty()) {
                        ...
                        TextView tvGedungA_3 = findViewById(R.id.tv_gedunga_3);
                        TextView tvGedungA_4 = findViewById(R.id.tv_gedunga_4);
                        ...
                        Toast.makeText(GedungA.this, "Data tidak tersedia", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Log.e("API_CALL", "onResponse - Error: " + response.code());
                    Toast.makeText(GedungA.this, "Gagal mengambil data", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void displayImages(List<String> imageUrls) {
        //image slider
        sliderView = findViewById(R.id.image_slider_gedunga);

        SliderGedungAAdapter sliderAdapter = new SliderGedungAAdapter(imageUrls, GedungA.this);
        ...
        sliderAdapter.setOnSliderItemClickListener(new SliderGedungAAdapter.OnSliderItemClickListener() {
            @Override
            public void onSliderItemClick(int position) {
                Intent intent = new Intent(GedungA.this, ViewSliderPicGedungA.class);
    ...
    protected void onStart() {
        ...
        Button edit = findViewById(R.id.edit_gedunga);
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GedungA.this, GedungAEdit.class);
                startActivity(intent);
            }
        });

        //button pindah activity ke pendaftaran kamar
        Button buttbookingnow = findViewById(R.id.booknow_gedunga);
        buttbookingnow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GedungA.this, BookingSekarang.class);
                startActivity(intent);
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_home) {
            Intent intent1 = new Intent(GedungA.this, MainActivity.class);
            startActivity(intent1);
        } else if (itemId == R.id.nav_carabooking) {
            Intent intent2 = new Intent(GedungA.this, CaraDaftarActivity.class);
            startActivity(intent2);
        } else if (itemId == R.id.nav_galeri) {
            Intent intent3 = new Intent(GedungA.this, GaleriActivity.class);
            startActivity(intent3);
        } else if (itemId == R.id.nav_snk) {
            Intent intent4 = new Intent(GedungA.this, SnKActivity.class);
            startActivity(intent4);
        } else if (itemId == R.id.nav_login) {
            Intent intent5 = new Intent(GedungA.this, Login.class);
            startActivity(intent5);
        } else if (itemId == R.id.nav_daftar) {
            Intent intent6 = new Intent(GedungA.this, Daftar.class);
            startActivity(intent6);
        } else if (itemId == R.id.nav_helpdesk) {
            Intent intent7 = new Intent(GedungA.this, Helpdesk.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_about) {
            Intent intent8 = new Intent(GedungA.this, About.class);
            startActivity(intent8);
        } else if (itemId == R.id.nav_data_mahasiswa) {
            Intent intent7 = new Intent(GedungA.this, DataMahasiswa.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_ubahpass) {
            Intent intent7 = new Intent(GedungA.this, UbahPassword.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_daftar_kamar) {
            Intent intent8 = new Intent(GedungA.this, DaftarKamar.class);
            startActivity(intent8);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(GedungA.this, Login.class);
        startActivity(intent);
        finishAffinity();
    }
