...
public class Deluxe5BEdit extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deluxe5b_edit);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Deluxe5BEdit.this, MainActivity.class);
        ...
        //sesuaikan activity
        drawerLayout = findViewById(R.id.drawer_layout_deluxe5bedit);
        navigationView = findViewById(R.id.navdrawer_view);
        ...
        Button saveEdit = findViewById(R.id.save_deluxe5b);
    ...
    private void tampilDataDeluxe5b() {

        EditText tvDeluxe5b_1 = findViewById(R.id.tv_deluxe5b_1);
        EditText tvDeluxe5b_2 = findViewById(R.id.tv_deluxe5b_2);
        EditText tvDeluxe5b_3 = findViewById(R.id.tv_deluxe5b_3);
        EditText tvDeluxe5b_4 = findViewById(R.id.tv_deluxe5b_4);
        EditText tvDeluxe5b_5 = findViewById(R.id.tv_deluxe5b_5);
        EditText tvDeluxe5b_6 = findViewById(R.id.tv_deluxe5b_6);
        EditText tvDeluxe5b_7 = findViewById(R.id.tv_deluxe5b_7);
        EditText tvDeluxe5b_8 = findViewById(R.id.tv_deluxe5b_8);
        EditText tvDeluxe5b_9 = findViewById(R.id.tv_deluxe5b_9);
        EditText tvDeluxe5b_10 = findViewById(R.id.tv_deluxe5b_10);

        RetrofitClient retrofitClient = RetrofitClient.getInstance(this);
        Api api = retrofitClient.getApi();

        Call<List<TampilDeluxe5b>> call = api.getDataDeluxe5b();
            ...
            public void onResponse(Call<List<TampilDeluxe5b>> call, Response<List<TampilDeluxe5b>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (dataItems != null && !dataItems.isEmpty()) {
                        ...
                        Toast.makeText(Deluxe5BEdit.this, "No data available", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(Deluxe5BEdit.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<TampilDeluxe5b>> call, Throwable t) {
                Toast.makeText(Deluxe5BEdit.this, "Network error", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void editDataDeluxe5b() {
        ...
        String editText1 = tvDeluxe5b_1.getText().toString();
        String editText2 = tvDeluxe5b_2.getText().toString();
        String editText3 = tvDeluxe5b_3.getText().toString();
        String editText4 = tvDeluxe5b_4.getText().toString();
        String editText5 = tvDeluxe5b_5.getText().toString();
        String editText6 = tvDeluxe5b_6.getText().toString();
        String editText7 = tvDeluxe5b_7.getText().toString();
        String editText8 = tvDeluxe5b_8.getText().toString();
        String editText9 = tvDeluxe5b_9.getText().toString();
        String editText10 = tvDeluxe5b_10.getText().toString();

        RetrofitClient retrofitClient = RetrofitClient.getInstance(this);
        Api api = retrofitClient.getApi();

        Call<UpdateDeluxe5b> call1 = api.updateDataDeluxe5b(1, editText1);
        Call<UpdateDeluxe5b> call2 = api.updateDataDeluxe5b(2, editText2);
        Call<UpdateDeluxe5b> call3 = api.updateDataDeluxe5b(3, editText3);
        Call<UpdateDeluxe5b> call4 = api.updateDataDeluxe5b(4, editText4);
        Call<UpdateDeluxe5b> call5 = api.updateDataDeluxe5b(5, editText5);
        Call<UpdateDeluxe5b> call6 = api.updateDataDeluxe5b(6, editText6);
        Call<UpdateDeluxe5b> call7 = api.updateDataDeluxe5b(7, editText7);
        Call<UpdateDeluxe5b> call8 = api.updateDataDeluxe5b(8, editText8);
        Call<UpdateDeluxe5b> call9 = api.updateDataDeluxe5b(9, editText9);
        Call<UpdateDeluxe5b> call10 = api.updateDataDeluxe5b(10, editText10);
    ...
    private final Callback<UpdateDeluxe5b> updateResponseCallback = new Callback<UpdateDeluxe5b>() {
        @Override
        public void onResponse(Call<UpdateDeluxe5b> call, Response<UpdateDeluxe5b> response) {
            if (response.isSuccessful()) {
                UpdateDeluxe5b updateDeluxe5b = response.body();
                String status = updateDeluxe5b.getStatus();
                String message = updateDeluxe5b.getMessage();
                if (status.equals("success")) {
                    successCount++;
                } else if (status.equals("error")) {
                    Toast.makeText(Deluxe5BEdit.this, "Gagal Memperbarui Data" + message, Toast.LENGTH_SHORT).show();
                    failureCount++;
                }

                if (successCount + failureCount == 9) {
                    Toast.makeText(Deluxe5BEdit.this, "Data Berhasil Diperbarui", Toast.LENGTH_SHORT).show();
                    successCount = 0;
                    failureCount = 0;

                    Intent intent = new Intent(Deluxe5BEdit.this, Deluxe5B.class);
                    startActivity(intent);
                }

            } else {
                Toast.makeText(Deluxe5BEdit.this, "Error" + response.message(), Toast.LENGTH_SHORT).show();
                failureCount++;
        ...
        @Override
        public void onFailure(Call<UpdateDeluxe5b> call, Throwable t) {
            Toast.makeText(Deluxe5BEdit.this, "Kesalahan jaringan" + t.getMessage(), Toast.LENGTH_SHORT).show();
            failureCount++;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_home) {
            Intent intent1 = new Intent(Deluxe5BEdit.this, MainActivity.class);
            startActivity(intent1);
        } else if (itemId == R.id.nav_carabooking) {
            Intent intent2 = new Intent(Deluxe5BEdit.this, CaraDaftarActivity.class);
            startActivity(intent2);
        } else if (itemId == R.id.nav_galeri) {
            Intent intent3 = new Intent(Deluxe5BEdit.this, GaleriActivity.class);
            startActivity(intent3);
        } else if (itemId == R.id.nav_snk) {
            Intent intent4 = new Intent(Deluxe5BEdit.this, SnKActivity.class);
            startActivity(intent4);
        } else if (itemId == R.id.nav_login) {
            Intent intent5 = new Intent(Deluxe5BEdit.this, Login.class);
            startActivity(intent5);
        } else if (itemId == R.id.nav_daftar) {
            Intent intent6 = new Intent(Deluxe5BEdit.this, Daftar.class);
            startActivity(intent6);
        } else if (itemId == R.id.nav_helpdesk) {
            Intent intent7 = new Intent(Deluxe5BEdit.this, Helpdesk.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_about) {
            Intent intent8 = new Intent(Deluxe5BEdit.this, About.class);
            startActivity(intent8);
        } else if (itemId == R.id.nav_data_mahasiswa) {
            Intent intent7 = new Intent(Deluxe5BEdit.this, DataMahasiswa.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_ubahpass) {
            Intent intent7 = new Intent(Deluxe5BEdit.this, UbahPassword.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_daftar_kamar) {
            Intent intent8 = new Intent(Deluxe5BEdit.this, DaftarKamar.class);
            startActivity(intent8);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(Deluxe5BEdit.this, Login.class);
        startActivity(intent);
        finishAffinity();
    }
}