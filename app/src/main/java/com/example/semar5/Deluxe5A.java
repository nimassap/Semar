...
public class Deluxe5A extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deluxe5a);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Deluxe5A.this, MainActivity.class);
        ...
        Call<List<String>> call1 = api.getGambarDeluxe5a();
        ...
        call1.enqueue(new Callback<List<String>>() {
            ...
            public void onResponse(Call<List<String>> call, Response<List<String>> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(Deluxe5A.this, "Error", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<String>> call, Throwable t) {
                ...
                Toast.makeText(Deluxe5A.this, "Kesalahan jaringan", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        //sesuaikan activity
        drawerLayout = findViewById(R.id.drawer_layout_deluxe5a);
        navigationView = findViewById(R.id.navdrawer_view);
        ...
        Call<List<TampilDeluxe5a>> call = api1.getDataDeluxe5a();
            ...
            public void onResponse(Call<List<TampilDeluxe5a>> call, Response<List<TampilDeluxe5a>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (dataItems != null && !dataItems.isEmpty()) {
                        ...
                        TextView tvDeluxe5a_3 = findViewById(R.id.tv_deluxe5a_3);
                        TextView tvDeluxe5a_4 = findViewById(R.id.tv_deluxe5a_4);
                        TextView tvDeluxe5a_5 = findViewById(R.id.tv_deluxe5a_5);
                        TextView tvDeluxe5a_6 = findViewById(R.id.tv_deluxe5a_6);
                        TextView tvDeluxe5a_7 = findViewById(R.id.tv_deluxe5a_7);
                        TextView tvDeluxe5a_8 = findViewById(R.id.tv_deluxe5a_8);
                        TextView tvDeluxe5a_9 = findViewById(R.id.tv_deluxe5a_9);
                        ...
                        Toast.makeText(Deluxe5A.this, "Data tidak tersedia", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Log.e("API_CALL", "onResponse - Error: " + response.code());
                    Toast.makeText(Deluxe5A.this, "Gagal mengambil data", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void displayImages(List<String> imageUrls) {
        //image slider
        sliderView = findViewById(R.id.image_slider_deluxe5a);

        SliderDeluxe5AAdapter sliderAdapter = new SliderDeluxe5AAdapter(imageUrls, Deluxe5A.this);
        ...
        sliderAdapter.setOnSliderItemClickListener(new SliderDeluxe5AAdapter.OnSliderItemClickListener() {
            @Override
            public void onSliderItemClick(int position) {
                Intent intent = new Intent(Deluxe5A.this, ViewSliderPicDeluxe5A.class);
    ...
    protected void onStart() {
        ...
        Button edit = findViewById(R.id.edit_deluxe5a);
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Deluxe5A.this, Deluxe5AEdit.class);
                startActivity(intent);
            }
        });

        //button pindah activity ke pendaftaran kamar
        Button buttbookingnow = findViewById(R.id.booknow_deluxe5a);
        buttbookingnow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Deluxe5A.this, BookingSekarang.class);
                startActivity(intent);
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_home) {
            Intent intent1 = new Intent(Deluxe5A.this, MainActivity.class);
            startActivity(intent1);
        } else if (itemId == R.id.nav_carabooking) {
            Intent intent2 = new Intent(Deluxe5A.this, CaraDaftarActivity.class);
            startActivity(intent2);
        } else if (itemId == R.id.nav_galeri) {
            Intent intent3 = new Intent(Deluxe5A.this, GaleriActivity.class);
            startActivity(intent3);
        } else if (itemId == R.id.nav_snk) {
            Intent intent4 = new Intent(Deluxe5A.this, SnKActivity.class);
            startActivity(intent4);
        } else if (itemId == R.id.nav_login) {
            Intent intent5 = new Intent(Deluxe5A.this, Login.class);
            startActivity(intent5);
        } else if (itemId == R.id.nav_daftar) {
            Intent intent6 = new Intent(Deluxe5A.this, Daftar.class);
            startActivity(intent6);
        } else if (itemId == R.id.nav_helpdesk) {
            Intent intent7 = new Intent(Deluxe5A.this, Helpdesk.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_about) {
            Intent intent8 = new Intent(Deluxe5A.this, About.class);
            startActivity(intent8);
        } else if (itemId == R.id.nav_data_mahasiswa) {
            Intent intent7 = new Intent(Deluxe5A.this, DataMahasiswa.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_ubahpass) {
            Intent intent7 = new Intent(Deluxe5A.this, UbahPassword.class);
            startActivity(intent7);
        } else if (itemId == R.id.nav_daftar_kamar) {
            Intent intent8 = new Intent(Deluxe5A.this, DaftarKamar.class);
            startActivity(intent8);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(Deluxe5A.this, Login.class);
        startActivity(intent);
        finishAffinity();
    }
